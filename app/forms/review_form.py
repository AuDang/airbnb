...
class ReviewForm(FlaskForm):
   ...
   spot_id = IntegerField("spot_id", vaidators=[DataRequired("Rating: Please give a rating from 1 to 5"), NumberRange(min=1, max=5, message='Number must be between 1 and 5')])
